...
if essay_type == '1':
    print(f'Предпологаемая оценка данного эссе по 12-ти бальной шкале: {prediction}')
if essay_type == '2':
    print(f'Предпологаемая оценка данного эссе по 5-ти бальной шкале: {prediction+1}')
